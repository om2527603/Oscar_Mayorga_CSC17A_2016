 ...
 * File:   main.cpp
 * Author: Oscar
 * Created on April 6, 2016, 3:24 PM
 * CSC-17A - Project 1
 */
...
int main(int argc, char** argv) {
    ...
    do{
        ...
        cout<<"Game number 1. Find the ball from 5 cups"<<endl;
        cout<<"Game number 2. Tic Tac Toe"<<endl;
...
void game1(int &start){
    ...
    if(input1==1){
        ...
        do{
            ...
            cout<<"Enter 2 if you want to Exit."<<endl;
            cin>>input2;
            if(input2==1)game1=0;
            if(input2==2)game1=1;
        }while(game1==0);
